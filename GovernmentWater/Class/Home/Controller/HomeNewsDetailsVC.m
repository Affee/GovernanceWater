...
-(UITableView *)tableViewW
{
    ...
    if (_tableViewW == nil) {
        _tableViewW = [[UITableView alloc]initWithFrame:CGRectMake(0, KKBarHeight, self.view.frame.size.width, self.view.frame.size.height - KKBarHeight - KKiPhoneXSafeAreaDValue - KKBarHeight) style:UITableViewStylePlain];
