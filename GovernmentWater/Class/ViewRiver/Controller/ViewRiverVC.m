...
@property (nonatomic, strong) NSMutableArray *coordinateArray1;
...
//    coor[0] = CLLocationCoordinate2DMake(location.location.coordinate.latitude, location.location.coordinate.longitude);
//
//    coor[1] = CLLocationCoordinate2DMake(location.location.coordinate.latitude+0.01, location.location.coordinate.longitude+0.01);
//
...
-(void)aaaaaa{
    CLLocationCoordinate2D coor[_coordinateArray.count];
    
    for (int i = 0; i <_coordinateArray.count; i++) {
        coor[i].latitude = [_coordinateArray[i] doubleValue];
        coor[i].longitude = [_coordinateArray1[i] doubleValue];
    }
        BMKPolyline * polyLine = [BMKPolyline polylineWithCoordinates:coor count:_coordinateArray.count];
        [_mapView addOverlay:polyLine];
}
